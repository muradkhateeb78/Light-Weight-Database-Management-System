...
public class Btree {
	...
	private String filePath="F:\\metadata\\";
	private static String rootPath="F:\\metadata\\root.dat";
	private int[] rootArray=new int[2];
...
//	}
	...
	public void print(internalNode head){
		if(head==null){
			System.out.println("Kia kar rahay ho...");
			return;
		}
		head.printNode();
		System.out.println();
...
//		}
	...
	public Btree(int primaryKey,String columnNames[]){
